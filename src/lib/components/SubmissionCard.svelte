      ...
      <form onsubmit={handleSubmit} class="space-y-4">
        <div>
          ...
          <input
            ...
            class="w-full rounded-md border {errors.githubRepoLink ? 'border-red-500' : 'border-gray-700'} bg-gray-900 px-4 py-2 text-white focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <div>
          ...
          <input
            ...
            class="w-full rounded-md border {errors.umlDesignLink ? 'border-red-500' : 'border-gray-700'} bg-gray-900 px-4 py-2 text-white focus:border-indigo-500 focus:ring-indigo-500"
