...
<div class="bg-transparent">
    <div class="mx-auto max-w-xl p-8 pl-7 ml-0">
            ...
            <div class="relative flex items-start space-x-3">
                ...
                <div class="min-w-0 flex-1 py-0">
                    <div class="text-md text-gray-500">
                        <div>
                            <a href="/" class="mr-2 font-medium text-white">{item.version}</a>
                            <a
                                href="/"
                            ...
                            >
                                <div class="absolute flex flex-shrink-0 items-center justify-center">
                                    <span 
                                        class="h-1.5 w-1.5 rounded-full {item.status === 'Online' ? 'bg-green-500' : 'bg-red-500'}" 
                                        aria-hidden="true"
                                    ></span>
                                </div>
