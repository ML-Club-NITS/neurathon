<script lang="ts">
  ...
  <div class="w-full h-fit  overflow-hidden rounded-md border border-gray-800 bg-gradient-to-r from-indigo-900/[0.3] to-black/[0.5] p-6 text-white opacity-95 shadow-lg backdrop-blur-sm">
    <div class="relative flex flex-col">
      <div class="mb-4 text-center">
        ...
        <p class="text-gray-300 font-thin mt-3 text-sm md:text-xl">
            {EventDescription}
        </p>
